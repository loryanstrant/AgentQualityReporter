...
Password gate backed by the ``app_users`` table (bcrypt). Tokens are signed HS256
JWTs carrying the username (``sub``) and role. Two dependencies gate routes:
:func:`get_current_user` (any authenticated user) and :func:`require_admin`.
"""
